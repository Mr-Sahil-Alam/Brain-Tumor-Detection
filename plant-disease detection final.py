...
directory_root = "PlantVillage/disease"
...
# Change the optimizer to legacy Adam
model.compile(optimizer=legacy.Adam(lr=0.0003, beta_1=0.9, beta_2=0.999, epsilon=None, decay=1e-8, amsgrad=False),
              loss='categorical_crossentropy',
              metrics=['accuracy'])
